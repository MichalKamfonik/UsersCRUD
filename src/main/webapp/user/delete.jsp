...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Na pewno usunąć użytkownika?</h6>
        </div>
        <div class="card-body">
            ...
            <form method="post" action="${pageContext.request.contextPath}/user/delete">
                ...
                <button type="submit" class="btn btn-primary" value="Tak" name="choice">Tak</button>
                <button type="submit" class="btn btn-primary" value="Nie" name="choice">Nie</button>
            </form>
        </div>
    </div>
